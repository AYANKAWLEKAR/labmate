      ...
      <div className="w-full max-w-md space-y-8 rounded-xl border border-slate-700 bg-slate-800/50 p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-md border border-slate-600 bg-slate-700/50 px-4 py-2 font-semibold text-white shadow-sm hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-slate-800 transition"
          >
